<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=20&pause=1000&color=FFFFFF&width=900&lines=🌟+Olá%2C+eu+sou+João+Paulo!+Seja+muito+bem-vindo+ao+meu+GitHub!" alt="Typing SVG"  width="100%" height="100%"/>
</p>
<br>

<div style="display: flex; align-items: flex-start; height: 200px; gap: 20px;">

<h1 align="center">Hello, World!</h1>
<p>Olá 👋, eu sou o João Paulo! Um estudante brasileiro apaixonado por <strong>💻 Tecnologia</strong> e <strong>📊 Ciência de Dados</strong>.</p>
...
<details>
  ...
  <br>
  <p>💬 Tenho 28 anos e atualmente moro no Brasil. Tenho conhecimento técnico em inglês e tenho cursos com <strong>🐍 Python, 🗄️ SQL, 📈 Análise de Dados, 📊 Visualização de Dados, 🤖 Machine Learning, 💻 Informática avançada</strong>, entre outros.</p>

  <p>Atualmente, trabalho como <strong>🔒 Vigilante</strong> na empresa <strong>Souza Lima</strong>, atuando no cliente <strong>🥤 Coca-Cola Femsa</strong>.  
  Também fui <strong>🚒 Brigadista</strong>, o que me ajudou a desenvolver habilidades importantes:</p>
  ...
  <ul>
    ...
    <li>🛠️ Gerenciamento de problemas</li>
  </ul>

  <p>🎯 Estou em busca de uma <strong>oportunidade de estágio em TI</strong>, onde eu possa aplicar e expandir minhas habilidades.</p>

  <h3>⚡ Interesses pessoais</h3>
  <p>📚 Gosto de ler — seja um bom livro, mangá ou HQ.<br>
  🎬 Assistir a filmes.<br>
  🎮 Jogar!<br>
  Acredito que nossos interesses pessoais contribuem para uma percepção mais refinada das coisas e para a resolução de problemas. \o/</p>
</details>
...
<details>
  <summary>🏡 Objetivo Pessoal</summary>
  <br>
  <p>Um dos meus maiores sonhos é <strong>construir minha própria casa</strong>, fruto do meu esforço e dedicação.</p>
  <p>Além disso, busco:</p>
  <ul>
    <li>💰 Alcançar <strong>estabilidade financeira</strong> para apoiar minha família.</li>
    <li>🌍 Ter a oportunidade de <strong>viajar</strong> e conhecer novas culturas.</li>
    <li>📚 Continuar investindo no meu <strong>desenvolvimento pessoal e acadêmico</strong>.</li>
    <li>🌱 Participar de projetos que tragam impacto positivo para a <strong>sociedade e o meio ambiente</strong>.</li>
  </ul>
</details>
...
<p align="center">
  <a href="mailto:joaodev.tech@outlook.com">
    <img src="https://github.com/gui-bus/TechIcons/blob/main/Dark/Outlook.svg" alt="Outlook" width="50" height="40">
  </a>
  <a href="https://wa.me/5511952854749">
    <img src="https://github.com/gui-bus/TechIcons/blob/main/Dark/Whatsapp.svg" alt="Whatsapp" width="50" height="40">
  </a>
  <a href="https://www.linkedin.com/in/joaopaulodevtech" target="_blank">
    <img src="https://github.com/gui-bus/TechIcons/blob/main/Dark/Linkedin.svg" alt="LinkedIn" width="50" height="40">
  </a>
</p>
